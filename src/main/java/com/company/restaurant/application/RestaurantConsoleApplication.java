...
public class RestaurantConsoleApplication {
    ...
    private static final HashMap<Integer, MenuItem> menuMenuMap = new HashMap<Integer, MenuItem>(){
        {
            ...
            put(MENU_MENU_ITEM_CODE_LIST, new MenuItemEmptyAction(MENU_MENU_ITEM_TEXT_LIST));
    ...
    private static final String KITCHEN_MENU_ITEM_TEXT_COOKED_COURSE_LIST = "Cooked course list";
