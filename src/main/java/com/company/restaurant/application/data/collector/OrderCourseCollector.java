 ...
 */
public class OrderCourseCollector extends ItemCollectorProto<OrderView, Course, OrderCourse>
    ...
    @Override
    protected void delItemFromObject(OrderView orderView, OrderCourse orderCourse) {
